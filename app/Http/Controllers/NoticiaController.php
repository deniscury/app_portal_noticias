...
class NoticiaController extends Controller
{
    ...
    public function index()
    {
        /*
            ...
            // Recuperar dado dentro do Redis
            $site = Cache::get('site');

            if (!Cache::has('dez_noticias')){
                $noticias = 
                Cache::put('dez_noticias', $noticias, 15);
            }

            $noticias = Cache::get('dez_noticias');
        */
        
        $noticias = [];
        
        $noticias = Cache::remember('dez_noticias', 15, function(){
